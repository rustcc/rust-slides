...
(function codeSnippets() {
    var playpenUrl = "https://play.rust-lang.org";
    //var playpenUrl = "http://127.0.0.1:5000";
    ...
    if (playpens.length > 0) {
        fetch_with_timeout(playpenUrl + "/meta/crates", {
            headers: {
    ...
    function run_rust_code(code_block) {
        ...
        fetch_with_timeout(playpenUrl + "/evaluate.json", {
            headers: {
                'Content-Type': "application/json",
            },
            method: 'POST',
